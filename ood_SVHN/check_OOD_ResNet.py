...
if __name__ == "__main__":
    ...
    # if not os.path.exists('results/auroc_ResNet34_CIFAR100.csv'):
    #     with open("results/auroc_ResNet34_CIFAR100.csv", "w") as f:
    #         wf = writer(f)
    ...
    # with open("results/auroc_ResNet34_CIFAR100.csv", "a") as f:
    #     wf = writer(f)
